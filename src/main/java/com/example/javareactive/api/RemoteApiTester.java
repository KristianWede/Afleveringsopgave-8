...
public class RemoteApiTester implements CommandLineRunner {
    ...
    public void getGendersNonBlocking() {
        ...
        for(GenderResponse gender: res){
            System.out.println("Name: " + gender.getName() + " Gender: " + gender.getGender());
        }
    }
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println(getGenderForName("Kristian").block().getGender());
